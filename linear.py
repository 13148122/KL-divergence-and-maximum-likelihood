...
def linear_model_main():
    ...
    beta_0 = np.linalg.pinv(X) @ Y
    print("min norm: ", beta_0)
    # d = len(beta_0)
    # print("size: ", d)
    ...
    # check the dimension of ns before you use it
    ns = null_space(X).T
    ...
    # print("ns: ", ns)
    # print("size of ns[i] column:", len(ns[1]))
